...
class Joystick_Converter{
    public:
        ...
        void speed_ms_conversion(uint16_t X_position, uint16_t Y_position, uint8_t brakes, std::function<void()> callback); //Convierte la posicion del joystick a una velocidad para el motor
